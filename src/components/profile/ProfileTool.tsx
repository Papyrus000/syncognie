...
const AVATAR_OUVERT    = '/images/profile/avatar-ouvert.png';
const AVATAR_EPUISE    = '/images/profile/avatar-epuise.png';
const AVATAR_TENDU     = '/images/profile/avatar-tendu.png';
