...
<div class="encart-lien-article">
  <div class="encart-lien-article-inner">
    ...
    <p class="encart-texte">Cette note est la troisième d'une série. Elle retourne contre les deux premières leur propre logique — ce qu'elles avaient promis, elle le conteste.</p>
...
<div class="encart-constellation">
  <div class="encart-constellation-inner">
    ...
    <p class="encart-texte">Watzlawick, Frankl, Gollwitzer font partie de la <strong>Constellation</strong> — une carte des penseurs et des œuvres qui traversent ce site.</p>
