...
Ce n'est pas leur faute — personne ne choisit son style d'attachement, il se forme avant qu'on puisse en décider quoi que ce soit. Mais c'est leur responsabilité — parce que dès qu'on peut voir ce qui se joue, on ne peut plus prétendre ne pas savoir. La responsabilité n't est pas d'avoir été formé ainsi. Elle est de ce qu'on en fait maintenant qu'on peut le voir.

---

## Ce que Esther Perel dérange
